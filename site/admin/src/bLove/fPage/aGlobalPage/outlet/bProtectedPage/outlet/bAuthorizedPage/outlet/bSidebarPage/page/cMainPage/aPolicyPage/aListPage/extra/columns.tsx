      ...
      return (
        <div className="flex space-x-2">
          <span className="max-w-[450px] truncate font-normal hover:underline">
            <Link to={`${fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.bSidebarRoute.cMainRoute.aPolicyRoute.cRetrieveRoute}/${row.getValue("_id")}`} >
    ...
    cell: ({ row }) => (
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-[160px]">
          ...
          <DropdownMenuItem asChild>
            <Link to={`${fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.bSidebarRoute.cMainRoute.aPolicyRoute.dUpdateRoute}/${row.getValue("_id")}`} >
              Update
            </Link>
          </DropdownMenuItem>
          <DropdownMenuSeparator />
          <DropdownMenuItem asChild>
            <Link to={`${fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.bSidebarRoute.cMainRoute.aPolicyRoute.eDeleteRoute}/${row.getValue("_id")}`} >
              Delete
            </Link>
          </DropdownMenuItem>
        </DropdownMenuContent>

...
const extras = {
  header: ({ id }: { id: string }) => ({
    ...
    buttons: [
      { text: "Update", to: `${fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.bSidebarRoute.cMainRoute.aPolicyRoute.dUpdateRoute}/${id}` },
      { text: "Delete", to: `${fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.bSidebarRoute.cMainRoute.aPolicyRoute.eDeleteRoute}/${id}` },
    ]
  }),
